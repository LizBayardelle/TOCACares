...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { approved: @testimonial.approved, body: @testimonial.body, category: @testimonial.category, featured: @testimonial.featured, title: @testimonial.title, user_id: @testimonial.user_id } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { approved: @testimonial.approved, body: @testimonial.body, category: @testimonial.category, featured: @testimonial.featured, title: @testimonial.title, user_id: @testimonial.user_id } }
