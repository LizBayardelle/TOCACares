...
class AuthorizationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post authorizations_url, params: { authorization: { account_created: @authorization.account_created, admin: @authorization.admin, committee: @authorization.committee, email: @authorization.email } }
    end
  ...
  test "should update authorization" do
    patch authorization_url(@authorization), params: { authorization: { account_created: @authorization.account_created, admin: @authorization.admin, committee: @authorization.committee, email: @authorization.email } }
